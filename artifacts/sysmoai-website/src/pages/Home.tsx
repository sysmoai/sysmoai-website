...
const audiences = [
  ...
  { icon: Laptop,        label: 'Freelancers',  href: '/for/freelancers', problems: ['Income dropped — "ChatGPT can do this"', 'Stuck at low-ticket ৳500 projects', 'Chaotic client management'], solution: 'We upgrade your skills, build your premium service package, and set up a Notion CRM so you can charge more for better-positioned services.' },
  { icon: FlaskConical,  label: 'Researchers',  href: '/for/researchers', problems: ['Literature review takes 4 weeks', 'Notes in 6 different apps', 'Paper writing is a bottleneck'], solution: 'We build your AI Research OS — literature review automated, notes organised, and your paper-writing workflow streamlined.' },
    ...
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      >
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }}
          ...
          >
            {[
              { label: 'Notion · n8n · Claude · WhatsApp API', icon: Sparkles },
              { label: 'Bangladesh-based · Serving globally', icon: Users },
          ...
          >
            {[
              ...
              { emoji: '🔬', color: '#60a5fa', label: 'Validation Pilot Active' },
              { emoji: '🔨', color: '#4ade80', label: 'We Build, Not Consult' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-60px' }} variants={stagger}
              ...
              {[
                ...
                { icon: TrendingUp, color: '#3B82F6', title: 'Consistent, scalable growth',     desc: 'More time on high-value client work. Less time on manual tasks.', result: 'Scalable' },
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={slideRight}
              ...
              <motion.div
                ...
                <div className="text-blue-400 font-bold text-xl">Calmer days</div>
                <div className="text-slate-400 text-xs">AI running the routine</div>
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════
          LEAD RESCUE — FEATURED PILOT
      ══════════════════════════════════════ */}
      <section className="py-20 md:py-24 relative overflow-hidden" style={{ background: isDark ? '#0A0B0F' : '#FFFBF0' }}>
        <div className="pointer-events-none absolute inset-0">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-5 border"
              style={{ background: isDark ? 'rgba(245,158,11,0.08)' : 'rgba(245,158,11,0.1)', borderColor: 'rgba(245,158,11,0.3)' }}>
              <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />
              <span className="text-xs font-bold tracking-wider uppercase" style={{ color: '#F59E0B' }}>Validation Pilot — Now Open</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4" style={{ color: isDark ? '#F1F5F9' : '#0A0B0F' }}>
              Lead Rescue System —{' '}
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-60px' }} variants={stagger}
            ...
            {[
              ...
              <motion.div key={i} variants={fadeUp}
                ...
                style={{
                  background: isDark ? 'rgba(245,158,11,0.06)' : 'rgba(255,255,255,0.85)',
                  border: `1px solid ${isDark ? 'rgba(245,158,11,0.15)' : 'rgba(245,158,11,0.25)'}`,
                }}>
                <div className="text-3xl mb-3">{item.icon}</div>
                <h3 className="font-bold mb-2 text-sm" style={{ color: isDark ? '#FDE68A' : '#92400E' }}>{item.title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: isDark ? '#94A3B8' : '#6B7280' }}>{item.desc}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp}
            ...
            style={{ background: isDark ? 'rgba(245,158,11,0.08)' : 'rgba(254,243,199,0.7)', border: `1px solid ${isDark ? 'rgba(245,158,11,0.2)' : 'rgba(245,158,11,0.35)'}` }}>
            <div>
              <div className="text-2xl font-black mb-0.5" style={{ color: isDark ? '#FDE68A' : '#92400E' }}>৳15,000</div>
              <div className="text-sm" style={{ color: isDark ? '#94A3B8' : '#6B7280' }}>
                14-day pilot · Acceptance test included · You own everything
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/lead-rescue"
                ...
                style={{ borderColor: isDark ? 'rgba(245,158,11,0.35)' : 'rgba(245,158,11,0.5)', color: isDark ? '#FDE68A' : '#92400E', background: 'transparent' }}>
                Full Details →
              </Link>
            </div>
          </motion.div>
